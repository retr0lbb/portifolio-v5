...
export const AboutPage: React.FC<AboutProps> = ({id}) => {
    return(
      ...
      >
        <h1 id={id} className="text-7xl font-bold font-mono w-full dark:text-background-ligth">Me conheça um pouco melhor:</h1>
        <section className="w-full grid grid-cols-5 gap-5">
            <AboutCard />
            <NanoCard.root className="row-span-1 bg-contrast-dark">
              <NanoCard.title>Tecnologias</NanoCard.title>
              <NanoCard.body className="grid-cols-2 gap-2">
                <div className="dark:bg-background-dark/30 rounded-md flex items-center justify-center">
            ...
            <NanoCard.root className="col-span-2">
              ...
              <NanoCard.body className="grid-cols-3 grid-rows-1 gap-4 p-3">
                <div className="dark:bg-background-dark/30 flex flex-col items-center justify-center px-5 py-4">
                  <div className="text-xl p-2 dark:text-background-ligth">Filmes</div>
            ...
            <NanoCard.root className="col-span-2">
              ...
              <NanoCard.body className="grid-cols-2 grid-rows-1 place-items-center gap-2">
                <div className="w-full h-full flex flex-col items-center p-4 dark:bg-background-dark/30 rounded-md">
                  <div className="text-xl text-zinc-200">Udemy</div>
                  <SiUdemy size={64} className="flex-1 text-background-ligth" />
                ...
                <div className="w-full h-full flex flex-col items-center p-4 dark:bg-background-dark/30 rounded-md">
                  ...
                  <Backpack size={64} className="flex-1 text-background-ligth" />
