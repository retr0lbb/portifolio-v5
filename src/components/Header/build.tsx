...
import { Folder, LucideHome, Menu, Phone, User2, X } from "lucide-react"
...
export const build: React.FC = () => {
    ...
    <Root className="justify-between">
        <nav className="text-white/60">
          ...
          <ul 
          className={`absolute flex flex-col gap-5 py-10 border bg-contrast-dark border-contrast-light/40 rounded-lg px-10 items-baseline left-0 top-16 transition-all ${isTapped? "translate-x-0" :"-translate-x-72"} md:translate-x-0 md:border-none md:flex md:flex-row md:static md:items-center justify-evenly md:gap-4 md:px-0 md:py-0 text-xl`}>
